...
<link rel="stylesheet" media="screen, print, handheld" type="text/css" href="http://localhost:8085/FestivalWeb/style/calendrier.css" />
...
<body>
		...
		<DIV class="div">	
			...
			<legend>
  			...
  			</p><input id="groupesel" type="text" name="groupesel" size="30" maxlength="10"
			<% 
				if (request.getAttribute("maj") != null) 
				{ %>value="<%=ligne[0] %>"<% } 
			%>
			...
			<legend>
  			...
  			<input id="heuresel" type="text" name="heuresel" size="10" maxlength="5"
			<% 
				if (request.getAttribute("maj") != null) 
				{ %>value="<%=ligne[2] %>"<% } 
			%>
			...
			<legend>
  			...
  			<input id="dureesel" type="text" name="dureesel" size="5" maxlength="5"
  			<% 
				if (request.getAttribute("maj") != null) 
				{ %>value="<%=ligne[3] %>"<% } 
			%>
